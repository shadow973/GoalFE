...
export class NavbarStore {
    ...
    getMobileNavbarItems(): any[] {
        return this._navbarItemsMobile;
    }

    get mobileMenuOpen() {
        return this._mobileMenuOpen$.getValue();
    }
    ...
    toggleBurger() {
        this._mobileMenuOpen$.next(!this.mobileMenuOpen);
    }

    closeBurger() {
        this._mobileMenuOpen$.next(false);
    }
